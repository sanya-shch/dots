...
import {
  ...
  updateGameCodes,
  getGameCodes,
} from "../../firebase/gameRoomCodes";
import { setGameRoomData } from "../../firebase/gameRooms";
import { getUserId } from "../../utils/getUserId";
import { getSixLetterCode } from "../../utils/getSixLetterCode";
  ...
  return (
    <div className="home_page">
      ...
      <div className="input_block">
        <button className="create_btn button" onClick={handleClickCreateGame}>
          Create Game
        </button>
